          ...
          <FlexBox>
            ...
            <div className="flex-6" style={{ paddingTop: "30px" }}>
              ...
              <FlexBox style={{ marginTop: "20px" }}>
                ...
                <div className="flex-1">&nbsp;</div>
                <div className="flex-6"><a onClick={() => {window.open('https://www.youtube.com/playlist?list=PLHGvDasahwZMko2OayS24NEzWYf3sMq2w','_blank')}} >linkUrl</a></div>
              </FlexBox>
              <FlexBox style={{ marginTop: "20px" }}>
              ...
              <FlexBox style={{ marginTop: "20px" }}>
                ...
                <div className="flex-1">&nbsp;</div>
                <div className="flex-6"><a onClick={() => {window.open('https://github.com/gold0073/NodeJs ','_blank')}} >linkUrl</a></div>
              </FlexBox>
            </div>
          </FlexBox>
          <IconsBox>
